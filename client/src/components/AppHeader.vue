<template>
        ...
        <div class="container mx-auto">
            <div class="grid grid-cols-12 gap-4 items-center w-full">
                ...
                <div
                    ...
                    <span class="text-gray-300">•</span>
                    <a href="/contact"
                        class="text-gray-300 hover:text-white transition-colors whitespace-nowrap">Contact</a>
                </div>
    ...
    <v-layout>
        <v-navigation-drawer v-model="drawer" temporary location="right" class="nav-drawer" width="250">
            <div class="px-4 py-6">
                <!-- Close Button -->
                ...
                <div class="mt-6 flex flex-col space-y-4">
                    <button block @click="handleShowSignUp"
                        class=" px-8 py-4 rounded-full bg-white/5 backdrop-filter backdrop-blur-lg text-white hover:bg-white/5 active:bg-white/10 transition-colors space-x-2 shadow-inner shadow-white/20 text-center">Get
                        Started
                    </button>
...
const authModalRef = ref<InstanceType<typeof AuthModal> & AuthModalMethods | null>(null);
